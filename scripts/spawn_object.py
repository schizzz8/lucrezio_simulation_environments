...
if __name__ == "__main__":
    ...
    for key, value in objects.iteritems():
        ...
        # get file location
        try:
            file_location = roslib.packages.get_pkg_dir('lucrezio_simulation_environments') + '/models/' + model_string + '/model.' + model_type
        except roslib.packages.InvalidROSPkgException:
            rospy.logerr("No model package found for " + key + ": " + lucrezio_simulation_environments + " does not exist in ROS_PACKAGE_PATH")
            continue
